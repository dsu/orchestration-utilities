...
from libs.ansi2html import get_styles, SCHEME
import six
...
_html_template_old = six.u("""<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
<div class="body_foreground body_background" style="font-size: %(font_size)s;" >
<pre id="content">
%(content)s
</pre>
</div>
